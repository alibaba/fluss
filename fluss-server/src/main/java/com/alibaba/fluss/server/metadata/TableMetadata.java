...
public class TableMetadata {
    ...
    /**
     * The already delete table id. This table id will be used in UpdateMetadata request to identify
     * this table already deleted, and tabletServers need to clear the metadata of this table.
     */
