...
public class AuthenticationTest {
    ...
    void testNormalAuthenticate() throws Exception {
        ...
        clientConfig.set(ConfigOptions.CLIENT_AUTHENTICATE_PROTOCOL, "username_password");
        clientConfig.setString("client.authenticate.username_password.username", "root");
        clientConfig.setString("client.authenticate.username_password.password", "password");
    ...
    void testWrongPassword() throws Exception {
        ...
        clientConfig.set(ConfigOptions.CLIENT_AUTHENTICATE_PROTOCOL, "username_password");
        clientConfig.setString("client.authenticate.username_password.username", "root");
        clientConfig.setString("client.authenticate.username_password.password", "password2");
        try (NettyClient nettyClient =
                new NettyClient(clientConfig, TestingClientMetricGroup.newInstance())) {
            ListDatabasesRequest request = new ListDatabasesRequest();
            assertThatThrownBy(
    ...
    private void buildNettyServer() throws Exception {
        ...
        confMap.put(
                ConfigOptions.SERVER_AUTHENTICATE_PROTOCOL_MAP.key(), "CLIENT:username_password");
        confMap.put("server.authenticate.username_password.username", "root");
        confMap.put("server.authenticate.username_password.password", "password");
