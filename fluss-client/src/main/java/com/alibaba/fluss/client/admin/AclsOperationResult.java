...
import com.alibaba.fluss.rpc.messages.PbAclRespInfo;
...
import static com.alibaba.fluss.client.utils.ClientRpcMessageUtils.toAclBinding;
 ...
 * @since 0.6
 */
public class AclsOperationResult {
    private final Map<AclBinding, CompletableFuture<Void>> futures;

    public AclsOperationResult(Map<AclBinding, CompletableFuture<Void>> futures) {
     ...
     *
     * <p>For each {@link PbAclRespInfo} in the collection, Completes the future with success or
     * failure based on the response's error code.
     *
     * @param pbAclRespInfos Collection of protobuf response messages containing ACL operation
     *     results.
     */
    public void complete(Collection<PbAclRespInfo> pbAclRespInfos) {
