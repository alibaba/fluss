...
public interface Admin extends AutoCloseable {
     ...
     *
     * <p>If {@code principal} is {@code null}, returns all ACL entries for the resource.
     *
     * @param resource The resource to query ACL entries for.
     * @param principal The principal (user/role) to filter entries by, or {@code null} for all
     *     entries.
     * @return A CompletableFuture containing the filtered ACL entries.
     */
    CompletableFuture<Collection<AclBinding>> listAcls(
            Resource resource, @Nullable FlussPrincipal principal);
     ...
     */
    AclsOperationResult createAcls(Collection<AclBinding> aclBindings);
     ...
     *
     * @param aclBindings List of ACL entries to remove.
     * @return A CompletableFuture indicating completion of the operation.
     */
    AclsOperationResult dropAcls(Collection<AclBinding> aclBindings);
}
